...
# all of the global variables & assets intializing
# initializing window
...
back_img= pygame.image.load('background-day.png')
floor_img = pygame.image.load('base.png')
floor_x = 0
